          ...
          <div class="view view-autos">
            <div class="autodash on">
              ...
              <div class="cmddrawer" id="dashCmd">
                <div class="cmdintro"><b id="dashCmdTitle">快捷指令</b><span id="dashCmdHint">查询与调整策略</span></div>
                <div class="cmdexamples" id="dashCmdEx">
                  <div><b>查状态</b><span data-act="stgquick" data-arg="current">查看当前策略</span><span data-act="stgquick" data-arg="progress">查看执行进度</span></div>
                  <div><b>查结果</b><span data-act="stgquick" data-arg="round">查看本轮报告</span><span data-act="stgquick" data-arg="today">查看今日报告</span></div>
                  <div><b>投注设置</b><span data-act="cmdinsert" data-arg="amount">修改每注金额</span><span data-act="stgquick" data-arg="plays">调整投注玩法</span></div>
                  <div><b>风控与时间</b><span data-act="cmdinsert" data-arg="stopwin">修改止盈</span><span data-act="stgquick" data-arg="schedule">设置运行时段</span></div>
                </div>
                <div class="cmd-search-results" id="dashCmdSearch"></div>
                <div class="cmd-more-list" id="dashCmdMore"></div>
                <div class="cmd-foot"><button class="cmd-more" data-act="cmdmore">更多指令 <span>3</span></button><button class="cmd-help" data-act="stgquick" data-arg="help"><i>?</i><span>指令说明</span></button></div>
              </div>
              <!-- 未启用官方模板：固定底部决策区；与指令栏互斥显示 -->
              <div class="stg-preview-actions" id="stgPreviewActions"></div>
              <div class="inputbar stg-commandbar"><button class="slash shortcut-trigger" type="button" data-act="dashcmds" aria-label="打开快捷指令"><span class="shortcut-icon" aria-hidden="true"><svg viewBox="0 0 1024 1024" focusable="false"><path d="M794.016 154.016q32.992 0 54.496 21.504t21.504 55.008-21.504 54.496-54.496 22.016h-76.992V230.048q.992-32.992 22.016-54.496t55.008-21.504zm-564 0q34.016 0 55.008 21.504t22.016 54.496v76.992H230.048q-32.992-.992-54.496-22.016t-21.504-54.496 21.504-55.008 54.496-21.504zm384 256v204h-204v-204h204zm180 306.976q32.992.992 54.496 22.016t21.504 54.496-21.504 55.008-55.008 21.504-54.496-21.504-22.016-54.496v-76.992h76.992zm-487.008 0v76.992q-.992 32.992-22.016 54.496t-54.496 21.504-55.008-21.504-21.504-55.008 21.504-54.496 54.496-22.016h76.992zM794.016 51.008q-76.992 2.016-127.488 52.512t-52.512 126.496v76.992h-204V230.016q-2.016-76-52.512-126.496T230.016 51.008q-76 2.016-126.496 52.512T51.008 230.016q2.016 76.992 52.512 127.488t126.496 52.512h76.992v204H230.016q-76 2.016-126.496 52.512t-52.512 127.488q2.016 76 52.512 126.496t126.496 52.512q76.992-2.016 127.488-52.512t52.512-126.496v-76.992h204v76.992q2.016 76 52.512 126.496t127.488 52.512q76-2.016 126.496-52.512t52.512-126.496q-2.016-76.992-52.512-127.488t-126.496-52.512h-76.992v-204h76.992q76-2.016 126.496-52.512t52.512-127.488q-2.016-76-52.512-126.496T794.016 51.008z"/></svg></span></button><div class="field ph" contenteditable="true" role="textbox" aria-label="输入指令调整策略" data-placeholder="输入指令调整策略">输入指令调整策略</div><button class="cmd-clear" type="button" data-act="cmdclear" aria-label="清空输入">×</button><button class="sendico" type="button" aria-label="发送指令">➤</button><div class="cmd-suggest" id="stgCmdSuggest"></div><div class="cmd-validation" id="stgCmdValidation" aria-live="polite"></div></div>
            </div>
            ...
            <!-- 排除玩法（叠加于策略设置弹窗之上，二级 bottom sheet） -->
            <div class="tpl-modal" id="stgExSheet">
              <div class="cf-backdrop" data-act="stgexclose"></div>
              <div class="cf-sheet"><div id="stgExBody"></div></div>
            </div>
            ...
            <!-- 快捷指令 · 取值数字键盘（插入指令后弹出填值 · 2026-07-22） -->
            <div class="tpl-modal" id="stgNum">
              <div class="cf-backdrop" data-act="cmdnumclose"></div>
              <div class="cf-sheet"><div id="stgNumBody"></div></div>
            </div>
...
(window.IM168_VIEWS=window.IM168_VIEWS||[]).push({o:24,h:`
          ...
          <div class="view view-formula">
            <div class="subhead"><span class="bk" data-act="show" data-arg="autos"><svg class="icx" viewBox="25.0 51.0 11.0 17.0" fill="none"><path d="M34 66L27 59.5L34 53" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></span><b><span class="t-new">新建自动投策略</span><span class="t-edit">策略设置</span></b><span class="rt"></span></div>
            ...
            <div class="scroll2">
              <div class="monitor">
                ...
                <button class="stopbtn">急停 · 停止本策略</button>
              </div>
              <div class="frow"><div class="lt"><b>策略名称</b><i class="finfo" data-tip="用于识别与分享该自动投策略，可保存为常用模板重复使用。">i</i><span>方便识别与分享</span></div><input type="text" class="plname" placeholder="给策略起个名字"></div>
              <div class="tipline"></div>

              <div class="sectit">1 · 玩法范围 <i class="finfo" data-tip="系统会持续扫描 SG飞艇全部10个名次（冠军~第十名）及5组龙虎对位。这里选中的类别决定扫描范围，类别内每个名次/对位各自独立判断、独立触发，互不影响。再点一次已选类别即可取消（等同排除）。">i</i></div>
              <div class="tipline"></div>
              ...
              <div class="frow"><div class="lt"><b>止盈</b><i class="finfo" data-tip="止盈止损按全部被触发的投注项合并累计计算：合计盈利达到止盈、或合计亏损达到止损，整个策略立即停止。">i</i></div><div class="stepper" id="tpStepper"><button>−</button><span class="val" style="color:var(--muted)">—</span><button>+</button></div></div>
              <div class="tipline"></div>
              ...
              <div class="frow"><div class="lt"><b>暂停自动投时间</b><i class="finfo" data-tip="到达该时间点，策略自动暂停投注。">i</i><span>到点自动暂停</span></div><input type="time" class="timein"></div>
              <div class="tipline"></div>
              <div class="frow"><div class="lt"><b>恢复投注时间</b><i class="finfo" data-tip="到达该时间点，策略自动恢复投注。">i</i><span>到点自动恢复</span></div><input type="time" class="timein"></div>
              <div class="tipline"></div>
                ...
                <div id="dbqForm">
                  <div class="bq-card">
                    ...
                    <div class="stg-opts two" id="dbqModeSeg">
                      <div class="stg-opt" data-act="dbqmode" data-arg="两面"><div class="t">两面</div><div class="d">大小 / 单双 / 龙虎</div></div>
                      <div class="stg-opt" data-act="dbqmode" data-arg="定位"><div class="t">定位</div><div class="d">1–10位置排名</div></div>
                    </div>
                  </div>
                  <div class="bq-card" id="dbqDirCard" style="display:none;">
                    <div class="bq-lab">回测方式</div>
                    <div class="stg-opts" id="dbqDirSeg">
                      <div class="stg-opt" data-act="dbqdir" data-arg="跟投"><div class="t">跟投</div><div class="d">同方向连开回测（长龙）</div></div>
                  ...
                  <div class="bq-card" id="dbqPosWrap" style="display:none;">
                    ...
                    <div class="stg-grid"><div class="stg-stp full" id="dbqCandFieldPos"><div class="col"><div class="num"><span class="val">6 回合</span></div><div class="lbl">你打算设置的回合数</div></div><div class="sbtns"><button data-act="dbqcand" data-d="-1">−</button><button data-act="dbqcand" data-d="1">+</button></div></div></div>
                  </div>
                  <div class="bq-card" id="dbqRangeWrap" style="display:none;">
                    ...
                    <div class="bq-lab" style="margin-top:12px;">候选下注回合数</div>
                    <div class="stg-grid"><div class="stg-stp full" id="dbqCandField"><div class="col"><div class="num"><span class="val">6 回合</span></div><div class="lbl">你打算设置的回合数</div></div><div class="sbtns"><button data-act="dbqcand" data-d="-1">−</button><button data-act="dbqcand" data-d="1">+</button></div></div></div>
                  </div>
                </div>
...
(window.IM168_VIEWS=window.IM168_VIEWS||[]).push({o:27,h:`
          ...
          <div class="view view-templates">
            ...
            <div class="scroll2">
              ...
              <div class="tplnew" data-act="stgnew">＋ 不用模板，自定义新策略</div>
            </div>
          </div>
`});
